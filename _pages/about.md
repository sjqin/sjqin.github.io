...
Figure 2: Spatio-temporal distributions of the modulus of the numerical solutions to the one-dimensional nonlinear Schrödinger equation (NLSE), obtained via CNS (left) and RKwD (right). For more details, please see [*Physica D: Nonlinear Phenomena* (2024), vol. 470, 134355](https://doi.org/10.1016/j.physd.2024.134355).
