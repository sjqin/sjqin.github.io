...
Figure 1: Instantaneous temperature departure fields of two-dimensional turbulent Rayleigh-Bénard convection (RBC) given by Clean Numerical Simulation (marked by CNS, left) and Runge-Kutta method with double precision (marked by RKwD, right). For more details, please see [*Journal of Fluid Mechanics* (2022), vol. 948, A7](https://doi.org/10.1017/jfm.2022.710).

![Figure 2](/images/Figure2.jpg)

Figure 2: Spatio-temporal distributions of the modulus of numerical solution for the one-dimensional nonlinear Schrödinger equation (NLSE) obtained via CNS (left) and RKwD (right). For more details, please see [*Physica D: Nonlinear Phenomena* (2024), vol. 470, 134355](https://doi.org/10.1016/j.physd.2024.134355).
